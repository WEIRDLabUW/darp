...
if [ ! -d "cloned/r3m" ]; then
    git clone git@github.com:facebookresearch/r3m.git cloned/r3m
...
if [ "$ROBOSUITE" = "true" ]; then
  ...
  # Robocasa Setup (uses internal versions of dependencies)
  # Order matters: install dependencies before robocasa itself
